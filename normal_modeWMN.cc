...
NS_LOG_COMPONENT_DEFINE ("Normal Mode Data Transmission in Wireless Mesh Network");
...
int packetCount,received_bits=0,transmitted_bits=0,endtoenddelay;
float first_transmittedpacket,last_transmittedpacket;
float throughput,localThrou,pdf,sum_of_ete_delay;
...
int main (int argc, char *argv[])
{
  ...
  cmd.Parse (argc, argv);
    ...
    NodeContainer nc_meshNodes,nc_sta1, nc_sta2,not_malicious,malicious; // ALL Nodes

    NetDeviceContainer meshDevices,staApDevices1,staApDevices2,staDevices1,staDevices2, apDevices1,apDevices2;

    Ipv4InterfaceContainer interfaces,staAp_interfaces1,staAp_interfaces2,staAp_interfaces3,staAp_interfaces4;
...
//******************************************* mesh node 6 to mesh node 3*******************************************
    ...
    app9->Setup (ns3UdpSocket9, sinkAddress9, m_packetSize, m_NumOfPacket, DataRate ("500Kbps"));
...
//*******************************************flow monitor*******************************************
  ...
  AnimationInterface anim("NormalModeWMN.xml"); // Mandatory
 ...
 anim.EnablePacketMetadata(true);
      ...
      Ptr<OutputStreamWrapper> routingStream = Create<OutputStreamWrapper> ("NormalModeWMN.routes", std::ios::out);
